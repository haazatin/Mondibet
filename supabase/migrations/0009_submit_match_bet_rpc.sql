...
begin
  ...
  on conflict on constraint match_bets_match_id_participant_id_key
  do update set
    predicted_home_score_90 = excluded.predicted_home_score_90,
    predicted_away_score_90 = excluded.predicted_away_score_90,
